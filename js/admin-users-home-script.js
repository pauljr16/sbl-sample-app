...
function generateUsersTabLeftSideHTML() {
  const usersTabLeftSideHTML = `
    ...
    <!-- Make Admin Button -->
    <button class="btn btn-outline-warning btn-block my-2" style="color:#fff;" onclick="resetMakeAdminModal(false)" data-toggle="modal" data-target="#make-admin-modal"> 
    ...
    <!-- Remove User Button -->
    <button class="btn btn-outline-warning btn-block my-2" style="color:#fff;" onclick="resetRemoveUserModal(false)" data-toggle="modal" data-target="#remove-user-modal"> 
    ...
    <!-- Print Users Button -->
    <button class="btn btn-outline-warning btn-block my-2" style="color:#fff;" onclick="printUsers()"> 
    ...
    <label id="change-profile-pic-button" style="color:#fff;" class="btn btn-outline-warning btn-block my-2" for="change-profile-pic-input">
  ...
  userList.forEach( user => {
    ...
    const tr = `
      <tr>
        ...
        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">${userData.name}</td>
        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;">${userData.contact}</td>
      </tr>
    `;
